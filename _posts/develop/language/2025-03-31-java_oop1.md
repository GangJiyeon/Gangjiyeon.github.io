...
used in one place<br>
• Logical if useful only to one other class – kinda “helper
classes” – and makes it more streamlined<br>
(2) It increases `encapsulatio`n<br>
• Hidden from the outside world<br>
(3) It can lead to more `readable and maintainable` code<br>
• put related small classes close to where they are needed
...
• 종류: member class, local class, anonymous class<br>
: 멤버변수, 생성자, 멤버함수, 클래스
