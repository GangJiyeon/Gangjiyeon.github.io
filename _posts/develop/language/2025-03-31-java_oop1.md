...
|분류|내용|
|:---:|---|
|필드 = 멤버 변수|member variables (class var, instance var)<br>클래스 내부에 선언되는 데이터 저장 공간<br>static/class-wide<br>• class var: static/class-wide-global, 전역<br>• instance var: Local (객체 안, within an object)|
|메쏘드 = 멤버 함수|methods (= member functions)<br>클래스 내부의 기능(동작)을 정의|
