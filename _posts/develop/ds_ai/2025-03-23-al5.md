...
**1) 예제 1**<br>
**`주어진 재귀식`**<br>
$t_n = t_{n/2} + 1$(단, \(n > 1\), \(n\)은 2의 거듭제곱)<br>
$t_1 = 1$
...
**`정당성 증명 (Proof of the correctness)`**<br>
$n = 1$일 때: $t_1 = 1 = \log 1 + 1$

**`귀납 가정 (Induction hypothesis)`**  <br>
$t_n = \log n + 1$

**`귀납 단계 (Induction step)`** – $2n$을 대입하여 다음을 보여야 함:<br>
$t_{2n} = \log (2n) + 1$

**`결론`**
$t_{2n} = t_{(2n)/2} + 1 = t_n + 1 = \log n + 1 + 1$<br>
$= \log n + \log 2 + 1$<br>
$= \log (2n) + 1$
