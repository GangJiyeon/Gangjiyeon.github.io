...
학교에서 알고리즘에 대해 배고 있는데 생각한 것과는 다르게 개념 위주의 수업이어서    
블로그에 정리를 하고 코드로 실습하는 건 개인적으로 하기로 했다
수업내용을 내가 이해하기 쉽게 재구성해보았다! 
